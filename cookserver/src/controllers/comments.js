...
module.exports = {
  list: async (req, res) => {
    ...
    if (!result) throw new CustomError("No Comment Found", 404);
  ...
  read: async (req, res) => {
    ...
    if (!result) throw new CustomError("No Comments found.", 404);
  ...
  update: async (req, res) => {
    /* 
            #swagger.tags = ['Comments']
            #swagger.summary = 'Update Comments'
        */
